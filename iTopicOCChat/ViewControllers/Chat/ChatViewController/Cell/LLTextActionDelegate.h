...
@optional
//点击了用户名
- (void)textUserDidTapped:(nonnull NSString *)phoneNumber userinfo:(nullable id)userinfo;
//点击@
- (void)textAtDidTapped:(nonnull NSString *)phoneNumber userinfo:(nullable id)userinfo;
