...
- (void)setupUI
{
    ...
    _widthPickerComponent = SCREEN_WIDTH;
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view
{
    ...
    if (component == 0) {
        ...
        [label setText:component == 1?self.arrayData[row]:self.titleUnit];
        [label setTextAlignment:component == 1?NSTextAlignmentCenter:NSTextAlignmentLeft];
